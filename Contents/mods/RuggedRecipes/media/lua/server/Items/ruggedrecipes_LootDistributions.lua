...
--SEEDS
table.insert(SuburbsDistributions["all"]["crate"].items, "RuggedRecipes.CucumberBagSeed");
table.insert(SuburbsDistributions["all"]["crate"].items, 0.75);

table.insert(ProceduralDistributions["list"]["GardenStoreMisc"].items, "RuggedRecipes.CucumberBagSeed");
table.insert(ProceduralDistributions["list"]["GardenStoreMisc"].items, 20);

table.insert(ProceduralDistributions["list"]["GigamartFarming"].items, "RuggedRecipes.CucumberBagSeed");
table.insert(ProceduralDistributions["list"]["GigamartFarming"].items, 20);

table.insert(SuburbsDistributions["SeedBag"].items, "RuggedRecipes.CucumberBagSeed");
...
table.insert(ProceduralDistributions["list"]["PostOfficeNewspapers"].items, "RuggedRecipes.RuggedRecipesMagazine2");
table.insert(ProceduralDistributions["list"]["PostOfficeNewspapers"].items, 0.5);
...
table.insert(ProceduralDistributions["list"]["MagazineRackMaps"].items, "RuggedRecipes.RuggedRecipesMagazine2");
table.insert(ProceduralDistributions["list"]["MagazineRackMaps"].items, 0.5);
...
table.insert(ProceduralDistributions["list"]["CrateMagazines"].items, "RuggedRecipes.RuggedRecipesMagazine2");
table.insert(ProceduralDistributions["list"]["CrateMagazines"].items, 0.5);
...
table.insert(ProceduralDistributions["list"]["ChineseKitchenFridge"].items, "RuggedRecipes.Cucumber");
table.insert(ProceduralDistributions["list"]["ChineseKitchenFridge"].items, 8);
table.insert(ProceduralDistributions["list"]["DinerKitchenFridge"].items, "RuggedRecipes.Cucumber");
table.insert(ProceduralDistributions["list"]["DinerKitchenFridge"].items, 4);
table.insert(ProceduralDistributions["list"]["FridgeGeneric"].items, "RuggedRecipes.Cucumber");
table.insert(ProceduralDistributions["list"]["FridgeGeneric"].items, 1);
table.insert(ProceduralDistributions["list"]["FridgeRich"].items, "RuggedRecipes.Cucumber");
table.insert(ProceduralDistributions["list"]["FridgeRich"].items, 2);
table.insert(ProceduralDistributions["list"]["GroceryStandVegetables2"].items, "RuggedRecipes.Cucumber");
table.insert(ProceduralDistributions["list"]["GroceryStandVegetables2"].items, 20);
table.insert(ProceduralDistributions["list"]["GroceryStandVegetables2"].items, "RuggedRecipes.Cucumber");
...
function Recipe.OnCreate.OpenJarGetOnlyLid (items, result, player)	
  local inv = player:getInventory();	
  inv:AddItem("Base.JarLid");	
end

--Pot return
function Recipe.OnCreate.GetThePotBack (items, result, player)	
  local inv = player:getInventory();	
